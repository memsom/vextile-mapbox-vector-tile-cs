...
public class PbfReader
{
    ...
    /// <para> refactor to return a DataView instead of a byte array</para>
    /// </summary>
    ...
    public byte[] View()
    {
        ...
        if (Tag == 0)
        {
            throw new PbfReaderException("call next() before accessing field value");
        }

        if (WireType != WireTypes.BYTES)
        {
            throw new PbfReaderException("not of type string, bytes or message");
        }
    ...
    public bool NextByte()
    {
        ...
        {
            throw new PbfReaderException("tag out of range");
        }
    ...
    public void SkipBytes(ulong skip)
    {
        if (_pos + skip > _length)
        {
            ...
            throw new PbfReaderException(msg);
        }
    ...
    public ulong Skip()
    {
        if (Tag == 0)
        {
            throw new PbfReaderException("call next() before calling skip()");
        }
        ...
        switch (WireType)
        {
            ...
            case WireTypes.UNDEFINED:
                throw new PbfReaderException("undefined wire type");
            default:
                throw new PbfReaderException("unknown wire type");
        }
